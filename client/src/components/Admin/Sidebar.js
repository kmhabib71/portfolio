...
const Sidebar = ({ setActiveMenuItem }) => {
  const [tastMenuOpen, setTaskMenuOpen] = useState(false);
        ...
        <ul>
          ...
          <li className="mb-8">
            <div
              ...
              <span className="font-bold pr-2">Task Management</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
